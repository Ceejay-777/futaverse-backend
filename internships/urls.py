...
from .views import ListInternshipView, UpdateInternshipView, ToggleInternshipActiveView, CreateInternshipOfferView, ApplyForInternshipView

urlpatterns = [
    path('', ListInternshipView.as_view(), name='list-create-internships'),
